...
func (r *AddonInstanceReconciler) SetupWithManager(mgr ctrl.Manager) error {
	r.heartbeatCheckerRate = common.DefaultAddonInstanceHeartbeatUpdatePeriod.Duration
...
func (r *AddonInstanceReconciler) Reconcile(
	...
	threshold := common.DefaultAddonInstanceHeartbeatTimeoutThresholdMultiplier *
